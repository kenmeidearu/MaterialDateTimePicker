package com.kenmeidearu.datetimepickerexample;
...
import com.kenmeidearu.materialdatetimepicker.time.RadialPickerLayout;
import com.kenmeidearu.materialdatetimepicker.time.TimePickerDialog;
    ...
    DatePickerDialog.OnDateSetListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modeDateOnly=(CheckBox) findViewById(R.id.mode_date_only);
        ...
        dateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dpd.dateOnly(modeDateOnly.isChecked());
                //dpd.showMonthPickerFirst(showMonthFirst.isChecked());
                ...
                dpd.enableSeconds(enableSeconds.isChecked());
                dpd.enableMinutes(enableMinutes.isChecked());
                dpd.setMaxDate(now);
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth,int hourOfDay,int minute,int second) {
        ...
        String minuteString = minute < 10 ? "0"+minute : ""+minute;
        String secondString = second < 10 ? "0"+second : ""+second;
        String date = "You picked the following date: "+dayOfMonth+"/"+(++monthOfYear)+"/"+year+" "+hourString+":"+minuteString+":"+secondString;
